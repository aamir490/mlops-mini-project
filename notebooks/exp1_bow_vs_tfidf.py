# ===========================
# BoW vs TF-IDF MLflow Experiment
# ===========================
...
mlflow.set_experiment("Bow_vs_TFIDF_5_Algorithms")
...
with mlflow.start_run(run_name="All_Experiments") as parent_run:
    ...
    for algo_name, algorithm in algorithms.items():
        for vec_name, vectorizer in vectorizers.items():
            ...
            with mlflow.start_run(run_name=f"{algo_name}_{vec_name}", nested=True) as child_run:
                ...
                # Log algorithm-specific hyperparameters
                ...
                # Save model safely
                model_dir = f"saved_model_{algo_name}_{vec_name}"
                ...
                # Print results
                print(f"✅ {algo_name} + {vec_name} logged: Accuracy={accuracy:.4f}, F1={f1:.4f}")

    # ===========================
    # Log notebook once at the end
    # ===========================
