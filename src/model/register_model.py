...
#             'stage': 'Staging',
#             'version': '1.0',
#             'registered_at': mlflow.utils.time.now().isoformat()
#         }
...
#             'stage': 'Staging',
#             'version': '1.0',
#             'registered_at': 'local_registration',
#             'model_path': model_info.get('model_path', './models/model.pkl')
#         }
...
#         try:
#             with open('reports/model_registry.json', 'w') as f:
#                 json.dump({'error': str(e), 'model_name': 'my_model'}, f)
#         except:
#             pass
...
# # E:\Campus-X\campusx_mlops\campusx_projectt\register_model.py